...
residual = zeros(40, 1);
    ...
    residual(3) = (y(28)) - (params(5)*y(63)*y(41)/y(60));
    residual(4) = (y(39)) - (y(41)*params(5)*y(68)/y(65));
    residual(5) = (params(10)*y(24)^params(3)) - (y(28)*y(23));
    residual(6) = (params(11)*y(35)^params(4)) - (y(39)*y(34));
residual(7) = 1-params(14)+params(14)*y(46)*y(22)-params(12)*y(21)*(y(21)-params(25))+T(2)*(y(61)-params(25))*y(62)/y(25);
residual(8) = 1-params(15)+params(15)*y(50)*y(33)-params(13)*y(32)*(y(32)-params(25))+T(4)*(y(66)-params(25))*y(67)/y(36);
...
residual(23) = params(21)*y(27)+(1-params(21))*y(38);
    ...
    residual(31) = (y(58)) - (y(41)-(steady_state(23)));
    residual(32) = (log(y(45))) - (params(31)*log(y(10))+x(it_, 1));
    residual(33) = (log(y(46))) - (params(32)*log(y(11))+x(it_, 2));
    residual(34) = (log(y(47))) - (params(33)*log(y(12))+x(it_, 3));
    residual(35) = (log(y(48))) - (params(34)*log(y(13))+x(it_, 4));
    residual(36) = (log(y(49))) - (params(35)*log(y(14))+x(it_, 5));
    residual(37) = (log(y(50))) - (params(36)*log(y(15))+x(it_, 6));
    residual(38) = (log(y(51))) - (params(37)*log(y(16))+x(it_, 7));
    residual(39) = (log(y(52))) - (params(38)*log(y(17))+x(it_, 8));
    residual(40) = (log(y(53))) - (params(39)*log(y(18))+x(it_, 9));
