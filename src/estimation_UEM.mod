...
model;
    ...
    % === Equations de mesure (HICP sur pic) ===
...
%----------------------------------------------------------------
varobs gy_H_obs gy_F_obs pi_H_obs pi_F_obs;
...
%   PARAM,                INITVAL,  LB, UB,   PRIOR,           P1,     P2
    ...
    rho_g_H,              0.85,     0,  0.99, beta_pdf,        0.7,    0.15;
    rho_g_F,              0.85,     0,  0.99, beta_pdf,        0.7,    0.15;
    ...
    stderr eta_g_H,       0.01,     ,   ,     inv_gamma_pdf,   0.01,   2;
    stderr eta_g_F,       0.01,     ,   ,     inv_gamma_pdf,   0.01,   2;
